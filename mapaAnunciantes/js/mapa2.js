...
if (navigator.geolocation) { // Se o navegador do usuário tem suporte ao Geolocation
   navigator.geolocation.getCurrentPosition(function (position) {
	  ...
	  var marker=new google.maps.Marker({position:pontoPadrao,map:map,title:"Voce esta Aqui!"});
	  /*
...
function carregarPontos() {
	...
	$.getJSON('pontos2.json', function(pontos) {
		...
		$.each(pontos, function(index, ponto) {
			...
			var marker = new google.maps.Marker({
				...
				title: "Anunciante localizada!",
				icon: 'img/marcador3.png'
			});
