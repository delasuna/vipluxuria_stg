...
<title>Guia de Mot&eacute;is - I - Vip Lux&uacute;ria - Acompanhantes Porto Alegre</title>
...
<body>
	<div id="wrap">
        ...
        <div id="titulo">
		  <h1>Guia de Motéis - I</h1>
        </div><!--titulo-->        
        <div id="content">
       	  <?php include("../../php/menu-moteis.php"); ?>

				<div class="motel">
					<strong>Motel Ilha Verde</strong><br />
					Rua Almirante Tamandare, 476<br />
