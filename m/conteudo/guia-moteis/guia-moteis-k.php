...
<title>Guia de Mot&eacute;is - K - Vip Lux&uacute;ria - Acompanhantes Porto Alegre</title>
...
<body>
	<div id="wrap">
        ...
        <div id="titulo">
		  <h1>Guia de Motéis - K</h1>
        </div><!--titulo-->        
        <div id="content">
       	  <?php include("../../php/menu-moteis.php"); ?>

				<div class="motel">
					<strong>Motel Kalahary</strong><br />
					<p>					  RS 239 - Km 17, 4535<br />
					  Rond&ocirc;nia &ndash; Novo Hamburo &ndash; RS <br />
				  (51) 3595.2003</p>
				</div>
