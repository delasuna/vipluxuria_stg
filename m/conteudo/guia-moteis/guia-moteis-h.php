...
<title>Guia de Mot&eacute;is - H - Vip Lux&uacute;ria - Acompanhantes Porto Alegre</title>
...
<body>
	<div id="wrap">
        ...
        <div id="titulo">
		  <h1>Guia de Motéis - H</h1>
        </div><!--titulo-->        
        <div id="content">
       	  <?php include("../../php/menu-moteis.php"); ?>

				<div class="motel">
					<strong>H Motel</strong><br />
					<p>					  Rua Lorena, 82<br />
					  Primavera &ndash; Novo Hamburgo &ndash; RS<br />
				    (51) 3595.1693</p>
				</div>
