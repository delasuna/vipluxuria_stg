...
<title>Guia de Mot&eacute;is - G - Vip Lux&uacute;ria - Acompanhantes Porto Alegre</title>
...
<body>
	<div id="wrap">
        ...
        <div id="titulo">
		  <h1>Guia de Motéis - G</h1>
        </div><!--titulo-->        
        <div id="content">
       	  <?php include("../../php/menu-moteis.php"); ?>

				<div class="motel">
					<strong>Motel Gêmeos</strong><br />
				  Av. Eduardo Prado, 1370<br />
				  Cavalhada - Porto Alegre - RS<br />
				  (51) 3248.2366<br />
				  <a href="http://www.motelgemeos.com.br" target="_blank">http://www.motelgemeos.com.br</a></div>
                  
				<div class="motel">
					<strong>Motel Giros</strong><br />
					<p>					  Av. Senador Salgado Filho, 818 <br />
					  Campina &ndash; S&atilde;o Leopoldo &ndash; RS <br />
				  (51) 3568.3334</p>
				</div>
