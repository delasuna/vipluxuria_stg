...
<title>Guia de Mot&eacute;is - X - Vip Lux&uacute;ria - Acompanhantes Porto Alegre</title>
...
<body>
	<div id="wrap">
        ...
        <div id="titulo">
		  <h1>Guia de Motéis - X</h1>
        </div><!--titulo-->        
        <div id="content">
       	  <?php include("../../php/menu-moteis.php"); ?>

			<div class="motel">
                    <strong>Motel Xangai</strong><br />
                    Av. Parobé, 1897 (RS 240 - Km 2)<br />
                    Scharlau - São Leopoldo - RS<br />
                    (51) 3568.1888<br />
                    <a href="http://www.motelxangai.com.br" target="_blank">http://www.motelxangai.com.br</a></div>
