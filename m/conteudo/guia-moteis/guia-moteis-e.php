...
<title>Guia de Mot&eacute;is - E - Vip Lux&uacute;ria - Acompanhantes Porto Alegre</title>
...
<body>
	<div id="wrap">
        ...
        <div id="titulo">
		  <h1>Guia de Motéis - E</h1>
        </div><!--titulo-->        
        <div id="content">
       	  <?php include("../../php/menu-moteis.php"); ?>

				<div class="motel">
					<strong>Motel do Engenho</strong><br />
				  Rua Dr. João Inácio, 128 <br />
