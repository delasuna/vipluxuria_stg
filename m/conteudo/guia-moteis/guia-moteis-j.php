...
<title>Guia de Mot&eacute;is - J - Vip Lux&uacute;ria - Acompanhantes Porto Alegre</title>
...
<body>
	<div id="wrap">
        ...
        <div id="titulo">
		  <h1>Guia de Motéis - J</h1>
        </div><!--titulo-->        
        <div id="content">
       	  <?php include("../../php/menu-moteis.php"); ?>

			  <div class="motel">
					<strong>Motel Jardim Kanto do Éden </strong><br />
				  Av. Coronel Marcos, 1171 <br />
				  Pedra Redonda - Porto Alegre - RS<br />
				  (51) 3222.2966</div>
