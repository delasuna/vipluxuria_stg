...
<title>Guia de Mot&eacute;is - R - Vip Lux&uacute;ria - Acompanhantes Porto Alegre</title>
...
<body>
	<div id="wrap">
        ...
        <div id="titulo">
		  <h1>Guia de Motéis - R</h1>
        </div><!--titulo-->        
        <div id="content">
       	  <?php include("../../php/menu-moteis.php"); ?>

				<div class="motel">
					<strong>Motel Rivage</strong><br />
					<p>					  Av. Senador Salgados Filho, 818<br />
					  Campina &ndash; S&atilde;o Leopoldo &ndash; RS<br />
				  (51) 3568.6622</p>
				</div>	

				<div class="motel">
					<strong>Motel Roda Vida</strong><br />
				  Rua Marechal Floriano Peixoto, 275 <br />
