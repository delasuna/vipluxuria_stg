...
<title>Guia de Mot&eacute;is - T - Vip Lux&uacute;ria - Acompanhantes Porto Alegre</title>
...
<body>
	<div id="wrap">
        ...
        <div id="titulo">
		  <h1>Guia de Motéis - T</h1>
        </div><!--titulo-->        
        <div id="content">
       	  <?php include("../../php/menu-moteis.php"); ?>

				<div class="motel">
					<strong>Taiko Motel</strong><br />
				  Av. Sertório, 5715<br />
				  Sarandi - Porto Alegre - RS<br />
				  (51) 3348.3800<br />
				  <a href="http://www.taikomotel.com.br" target="_blank">http://www.taikomotel.com.br</a></div>
