	...
	<div id="conteudo">
		...
		<form name="form2" action="mail.php"  method="post" enctype="multipart/form-data" >
			<fieldset class="encontre_box">
				...
				<div>
					<label>Informe seu nome de acordo com o que está no site VipLuxúria</label>
				</div>
				<div>
					<label class="lbl">Nome:</label>
					<input type="text" id="nome" name="nome" class="input" size="42" tabindex="1" required=""  aria-required="true">
				</div>
				<div>
			...
			<BR>
			<fieldset class="encontre_box">
				<label for="name" class="tituloForm">Imagens</label><BR>
				<div>
