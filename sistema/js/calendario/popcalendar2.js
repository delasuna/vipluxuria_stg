...
//Nome da variavel que vai receber a data final
var nomeDestino;
...
function closeHandler(cal) {
	if  (nomeDestino == "f_dt_fim_viagem" || nomeDestino == "dataFinal") {
		validaDataFinal();
  	}
	
	if  (nomeDestino == "f_dt_inicio_viagem" || nomeDestino == "dataInicial") {
		validaDataInicial();
  	}
...
function showCalendar (id)
{
	...
	nomeDestino = document.getElementById(id).name;
