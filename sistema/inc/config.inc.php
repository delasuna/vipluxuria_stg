...
define('SIS_EMAIL_RESPONSAVEL', 'admin@vipluxuria.com');
define('SIS_URL', 'www.vipluxuria.com');
...
define("LOGIN_ACESSONEGADO","Voc� n�o tem permiss�o para<br>acessar esta p&aacute;gina");
