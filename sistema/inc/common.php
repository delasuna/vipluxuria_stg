...
function anti_injection($sql) {
    ...
    $sql = trim($sql);        // Remove espaços em branco no início/fim
...
class UpdateSQL {
	...
	*/
    ...
    if ($type === "Number") {
        // Converte vírgula para ponto e garante valor numérico
...
/*****************************************************************************************************
	Classe para cria��o de formul�rios
*/
class Form {
	var $name;
	var $action;
...
class Table {
	...
	// agrupa c�lulas e adiciona na linha informando um id
...
/*****************************************************************************************************
	Classe pra gerar caixas de conte�do
*/
class Box {
	var $title;
	var $width;
	...
	// adiciona conte�do ao box
	// $texto : express�o html que ser� adicionada ao box
...
/*****************************************************************************************************
	Classe para gerar deck de bot�es
*/
class Button {
	var $nome;
	var $url;
	...
	/*
		...
		$nome : nome do bot�o
		$url : link que ser� chamado
		$target : frame em que o link ser� aberto
		$level : n�vel de acesso m�nimo que o usu�rio deve ter para visualizar este bot�o
	*/
...
/*****************************************************************************************************
	Classe para controlar erros da p�gina
*/
class Erro {
	var $strErro;
...
/*****************************************************************************************************
	fun��o para recuperar as vari�veis GET e POST
*/
...
/*****************************************************************************************************
	fun��o para recuperar vari�veis de sess�o
*/
...
/*****************************************************************************************************
	fun��o para definir vari�veis de sess�o
*/
...
/*****************************************************************************************************
	formata��o de texto para exibi��o, pode ser adaptado conforme necessidade do sistema
*/
...
/*****************************************************************************************************
	fun��o para verificar a exist�ncia de chaves estrangeiras
...
function formDate($nome_campo, $data="") {
	...
	//----- monta select do mes
	$aMes = array("nulo","Janeiro","Fevereiro","Mar�o","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro");
...
/*****************************************************************************************************
	...
	$sql : express�o sql que monta a lista (selecionar apenas 2 campos com os nomes "id" e "val"
	$name : nome do campo que ser� criado
	$idList : id do campo select que ser� criado	- "necess�rio para manipula��o de combos dinamicas"
	$default : valor inicial do campo
	$todos : texto indicativo, caso a lista permita valor null
	$js : express�o javascript
*/
...
/*****************************************************************************************************
	verifica se usu�rio pode acessar p�gina
	$nivel : valor num�rico que define o n�vel hier�rquico de acesso
*/
...
/*****************************************************************************************************
	fun��o que verifica se o usuario est� dentro do n�vel
	retorna boolean
*/
...
function geraSenha($tamanho=6) {
    ...
    $password = ""; // <<< inicializa a variável
...
function radioField($arr, $name, $sel = "", $js = "") {
    ...
    foreach ($arr as $key => $val) {
        $string = explode(",", $val);
        $valor = $string[0];
        $label = $string[1] ?? $valor; // caso não tenha segundo elemento
...
/*****************************************************************************************************
	Fun��o para gerar campo de data com calend�rio popup
...
/*****************************************************************************************************
	Fun��o para gerar campo de texto
	$fieldname : nome do campo que ser� criado
	$fieldvalue : valor inicial do campo
...
/*****************************************************************************************************
	...
	$fieldvalue : valor inicial do campo
	$lenght : tamanho do campo
	$id : id do campo text que ser� criado	- "necess�rio para manipula��o de text dinamicas"
	$maxlenght : capacidade do campo
	$js : express�o javascript
*/
...
/*****************************************************************************************************
	Fun��o para gerar campo de texto desabilitado
	$fieldname : nome do campo que ser� criado
	$fieldvalue : valor inicial do campo
	$lenght : tamanho do campo
	$maxlenght : capacidade do campo
...
/*****************************************************************************************************
	Fun��o para gerar campo de password
	$fieldname : nome do campo que ser� criado
	$fieldvalue : valor inicial do campo
	$lenght : tamanho do campo
	$maxlenght : capacidade do campo
...
/*****************************************************************************************************
	Fun��o para gerar campo de checkbox
	$fieldname : nome do campo que ser� criado
	$fieldvalue : valor inicial do campo
...
/*****************************************************************************************************
	Fun��o para gerar lista de campos checkbox
	$formField : nome do campo no formul�rio
	$formFieldValue : valor do campo no formul�rio
	$table : nome da tabela que formar� os checkboxes
	$keyField : campo chave da tabela
	$showField : campo que ser� exibido nos checkboxes
	$condition : condi��o de exibi��o dos registros (cl�usula WHERE)
*/
...
/*****************************************************************************************************
        Fun��o para gerar lista de campos checkbox
        $formField      : nome do campo no formul�rio
        $formFieldValue : valor do campo no formul�rio (valores separados por ,)
        $table          : nome da array que formar� os checkboxes ("0,Teste")
*/
...
/*****************************************************************************************************
	Fun��o para gerar campo textarea com controle de caracteres via javascript
...
/*****************************************************************************************************
 Fun��o para verificar campo duplicado
*/
...
/*****************************************************************************************************
	...
	fun��o auxiliar, use dtos()
*/
function _dttos($datetime) {
    $aDT = explode(" ", $datetime); // usar $datetime e não $str
    $s = $aDT[0];
    $t = $aDT[1] ?? '00:00:00'; // caso não tenha hora
    $aS = explode("-", $s);
...
/*****************************************************************************************************
	Exibi��o de alert em javascript
*/
function alert($msg) {
...
/*****************************************************************************************************
	Cria scroll no conte�do enviado
*/
...
/*****************************************************************************************************
 fun��o que gera a senha para o usu�rio e envia a senha para o email definido no cadastro e na troca de senha
*/
function geraSenhaMail(
    ...
    $message .= "Observação: Esta senha é gerada automaticamente e no primeiro acesso à área de administração será solicitado que você cadastre uma nova senha. A qualquer momento você poderá trocar sua senha na opção Segurança, na administração do site.<br /><br />";
...
/*****************************************************************************************************
 fun��o que salva valores de checkbox em tabela de associa��o
*/
