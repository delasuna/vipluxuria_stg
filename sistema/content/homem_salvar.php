...
$sql->setTable("homem");
$sql->setKey("idHomem", anti_injection(getParam("id")), "Number");
...
if (strlen(getParam("id"))>0) { // altera��o, retirar strlen se vier de edicao_aux
	...
	if (getParam("imagemCentral10") != NULL)
		$sql->addField("imagemCentral10", anti_injection(("imagemCentral10")), "String");
...
echo "<script>location.href='/sistema/content/homem_lista.php?clear=1';</script>";
