...
<head>
    ...
    <title>Vip Luxúria - Enquete</title>
    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Enquete</h1>
            </div>
            <hr>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <a class="btn btn-primary" href="enquete_edicao.php">Novo</a>
                            <a class="btn btn-danger" href="javascript:excluir()">Excluir</a>
                        </div>
                        <form method="post" class="d-flex align-items-center" action="enquete_lista.php">
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows() > 0) {
                                        while ($rs->getrow()) {
                                            ...
                                            echo "<td><a href='enquete_edicao.php?id=$id&pagina=$pg' class='text-decoration-none'>{$rs->field('pergunta')}</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
