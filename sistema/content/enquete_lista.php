			    ...
			    <div id="coluna-esquerda-full">
					...
					<script language="JavaScript">
						function excluir() {
							if (confirm('Excluir registros selecionados?')) {
								...
								//parent.content.document.frm.action = "enquete_excluir.php";
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='enquete_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							$table->addColumnHeader("Pergunta",true,"100%", "L"); // Título, Ordenar?, Largura, Alinhamento
							$table->addRow(); // adiciona linha (TR)
						
							while ($rs->getrow()) {
								$id = $rs->field("idEnquete"); // captura a chave primária do recordset
								...
								$table->addData(addLink($rs->field("pergunta"),"enquete_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));
