			    ...
			    <div id="coluna-esquerda-full">
            		<p> 
						...
						if (strlen($id)>0) { // edição
							...
							if ($rs->getrow()) {
								$idMural = $rs->field("idMural");	
								$nome = $rs->field("nome");
								$nomeAcompanhante = $rs->field("nomeAcompanhante");
								$comentario = $rs->field("comentario");
								$dataPublicacao = $rs->field("dataPublicacao");
								
								$flagAprovado = $rs->field("flagAprovado");
								$ip = $rs->field("IP");
								$nota = $rs->field("nota");
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='mural_lista.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td>
								</tr>
							</table>
						</div>
						...
						/* 	Formulário */
						$form = new Form("frm", "mural_salvar.php", "POST", "", "100%");
						...
						$form->addHidden("id",$idMural); // chave primária
						...
						$form->addField("Aprovado:", radioField($lista_preferencial, "flagAprovado",$flagAprovado));						
						$form->addFieldColspan2("Data Publicação: ", textField("dataPublicacao",$dataPublicacao,15,15));
						$form->addFieldColspan2("Nome: ", textField("nome",$nome,114,250));
						$form->addFieldColspan2("Nome Acompanhante: ", textField("nomeAcompanhante",$nomeAcompanhante,114,250));						
						$form->addFieldColspan2("Nota: ", textField("nota",$nota,15,15));						
						$form->addFieldColspan2("IP: ", textField("ip",$ip,15,15));
						$form->addFieldColspan2("Comentário: ", textAreaField("comentario",$comentario,7,114,250));
