                ...
                <div class="card-body">
                    ...
                    <?php
                        ...
                        if ($iSort > 0) {
                            ...
                            switch ($iSort) {
                                case 2:
                                    $orderBy = " ORDER BY assunto $direction";
                                    break;
                                case 3:
                                    $orderBy = " ORDER BY dataPublicacao $direction";
                                    break;
                            }
                        ...
                        if ($busca != "") {
                            ...
                            $whereBusca = " WHERE assunto LIKE '%$buscaSql%'";
                        }
                    ...
                    <div>
                        <a class="btn btn-primary" href="blog_edicao.php">Novo</a>
                        <a class="btn btn-danger" href="javascript:excluir()">Excluir</a>
                    </div>

                    <!-- Seleção de registros por página -->
                    <form name="form2" id="form2" method="post" action="blog_lista.php" class="row g-2 mb-3 justify-content-end">
                        <div class="col-auto">
                    ...
                    <div class="d-flex justify-content-around">
                        <form method="get" class="row g-2 mb-3 w-100">
                            ...
                            <div class="col-auto">
                                ...
                                <?php if ($busca != "") { ?>
                                    <a href="blog_lista.php" class="btn btn-secondary">
                                        Limpar
                                    </a>
                                <?php } ?>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows()>0) {
                                        while ($rs->getrow()) {
                                            ...
                                            echo "<td><a href='blog_edicao.php?id=$id&pagina=$pg' class='fw-semibold text-decoration-none'>{$rs->field('assunto')}</a></td>";
                                            echo "<td><a href='blog_edicao.php?id=$id&pagina=$pg' class='text-decoration-none'>{$rs->field('dataPublicacao')}</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
