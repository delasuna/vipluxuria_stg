			    ...
			    <div id="coluna-esquerda-full">
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='blog_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							$table->addColumnHeader("Assunto",true,"70%", "L"); // Título, Ordenar?, Largura, Alinhamento
							$table->addColumnHeader("Data",true,"30%", "L"); // Título, Ordenar?, Largura, Alinhamento
							$table->addRow(); // adiciona linha (TR)
						
							while ($rs->getrow()) {
								$id = $rs->field("idBlog"); // captura a chave primária do recordset
								...
								$table->addData(addLink($rs->field("assunto"),"blog_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));
								$table->addData(addLink($rs->field("dataPublicacao"),"blog_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));
