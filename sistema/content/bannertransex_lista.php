			    ...
			    <div id="coluna-esquerda-full">
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='bannertransex_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							while ($rs->getrow()) {
								$id = $rs->field("idBannerTransex"); // captura a chave primária do recordset
								...
								$table->addData(addLink($rs->field("descricao"),"bannertransex_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));
								$table->addData(addLink($rs->field("site"),"bannertransex_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));								
								/*
