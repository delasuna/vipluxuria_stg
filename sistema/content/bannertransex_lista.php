...
<head>
    ...
    <title>Vip Luxúria - Banner Transex</title>
    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Banner Transex</h1>
            </div>
            <hr>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <form method="post" class="d-flex align-items-center" action="bannertransex_lista.php">
