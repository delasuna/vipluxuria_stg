			    ...
			    <div id="coluna-esquerda-full">
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='seo_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							$table->addColumnHeader("Tipo SEO",true,"40%", "L"); // Título, Ordenar?, Largura, Alinhamento
							$table->addColumnHeader("Title",true,"60%", "L"); 							
							$table->addRow(); // adiciona linha (TR)
						
							while ($rs->getrow()) {
								$id = $rs->field("idSeo"); // captura a chave primária do recordset
