    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Vip Luxúria - SEO</h1>
            </div>
            <hr>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <?php
                        ...
                        FROM seo 
                        INNER JOIN tipoSeo
                        ON seo.idTipoSeo = tipoSeo.idTipoSeo
                        $whereBusca
                        $orderBy";
                    ...
                    <form name="form2" id="form2" method="post" action="seo_lista.php" class="row g-2 mb-3 justify-content-end">
                        <div class="col-auto">
                    ...
                    <div class="d-flex justify-content-around">
                        <form method="get" class="row g-2 mb-3 w-100">
                            ...
                            <div class="col-auto">
                                ...
                                <?php if ($busca != "") { ?>
                                    <a href="seo_lista.php" class="btn btn-secondary">
                                        Limpar
                                    </a>
                                <?php } ?>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows()>0) {
                                        while ($rs->getrow()) {
                                            ...
                                            echo "<td><a href='seo_edicao.php?id=$id&pagina=$pg' class='fw-semibold text-decoration-none'>{$rs->field('descricao')}</a></td>";
                                            echo "<td><a href='seo_edicao.php?id=$id&pagina=$pg' class='text-decoration-none'>{$rs->field('title')}</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
...
function excluir() {
    if (confirm('Excluir registros selecionados?')) {
        document.frm.action = "seo_excluir.php";
        document.frm.submit();
    }
}
</script>
