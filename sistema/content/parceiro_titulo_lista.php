			    ...
			    <div id="coluna-esquerda-full">
					...
					<script language="JavaScript">
						function excluir() {
							if (confirm('Excluir registros selecionados?')) {
								...
								//parent.content.document.frm.action = "parceiro_titulo_excluir.php";
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='parceiro_titulo_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							$table->addColumnHeader("Título",true,"100%", "L"); // Título, Ordenar?, Largura, Alinhamento
							$table->addRow(); // adiciona linha (TR)
						
							while ($rs->getrow()) { 
								$id = $rs->field("idParceiroTitulo"); // captura a chave primária do recordset
