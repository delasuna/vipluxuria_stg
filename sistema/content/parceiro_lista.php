    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Vip Luxúria - Parceiros</h1>
            </div>
            <hr>
                ...
                <div class="card-body">
                    ...
                    <?php
                        ...
                        if ($iSort > 0) {
                            ...
                            switch ($iSort) {
                                case 2:
                                    $orderBy = " ORDER BY titulo $direction";
                                    break;
                            }
                        ...
                        if ($busca != "") {
                            ...
                            $whereBusca = " WHERE titulo LIKE '%$buscaSql%'";
                        }
                    ...
                    <div>
                        <a class="btn btn-primary" href="parceiro_edicao.php">Novo</a>
                        <a class="btn btn-danger" href="javascript:excluir()">Excluir</a>
                    </div>

                    <!-- Seleção de registros por página -->
                    <form name="form2" id="form2" method="post" action="parceiro_lista.php" class="row g-2 mb-3 justify-content-end">
                        <div class="col-auto">
                    ...
                    <div class="d-flex justify-content-around">
                        <form method="get" class="row g-2 mb-3 w-100">
                            ...
                            <div class="col-auto">
                                ...
                                <?php if ($busca != "") { ?>
                                    <a href="parceiro_lista.php" class="btn btn-secondary">
                                        Limpar
                                    </a>
                                <?php } ?>
                            </div>
                            ...
                            <table class="table table-striped table-hover align-middle">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <?php
                                        $isDescDescricao = ($iSort === 2 && $iSorted === 2);
                                        ?>

                                        <th>
                                            <a href="?Sorting=2<?php echo $isDescDescricao ? '' : '&Sorted=2'; ?>"
                                            class="text-white text-decoration-none">
                                                Descrição
                                            </a>
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows()>0) {
                                        while ($rs->getrow()) {
                                            ...
                                            echo "<td><a href='parceiro_edicao.php?id=$id&pagina=$pg' class='fw-semibold text-decoration-none'>{$rs->field('titulo')}</a></td>";
                                            echo "<td><a href='parceiro_edicao.php?id=$id&pagina=$pg' class='text-decoration-none'>{$rs->field('descricao')}</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
