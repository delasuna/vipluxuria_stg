			    ...
			    <div id="coluna-esquerda-full">
					...
					<script language="JavaScript">
						function excluir() {
							if (confirm('Excluir registros selecionados?')) {
								...
								//parent.content.document.frm.action = "parceiro_excluir.php";
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='parceiro_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							while ($rs->getrow()) {
								$id = $rs->field("idParceiro"); // captura a chave primária do recordset
