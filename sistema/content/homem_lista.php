...
<head>
    ...
    <title>Painel Administrativo - Anunciantes Casais & Homens</title>

    <!-- Bootstrap -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">

    <!-- CSS antigos mantidos apenas se necessário -->
    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Anunciantes - Casais & Homens</h1>
            </div>
            <hr>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <form class="d-flex align-items-center" method="post" action="homem_lista.php">
