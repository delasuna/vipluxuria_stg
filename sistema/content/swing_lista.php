...
<div id="tudo">
    <div id="conteudo">
        ...
        <div id="titulo">
       		<div id="titulo-content"><h1>Swing</h1></div>
            <div class="traco"></div>
      	</div>
            ...
            <div id="principal-content">
			    <div id="coluna-esquerda-full">
					...
					<?php
						...
						// Query
						$sql = "SELECT * FROM swings " . getSession("sOrder");
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									<a class='botao' href='javascript:gerar()'>&nbsp;Gerar Arquivo&nbsp;</a>				
					...
					<?php
						...
						$table->addColumnHeader("Autor",true,"42%","L");
						$table->addColumnHeader("E-mail",true,"50%","L");
						$table->addColumnHeader("Ativo",true,"8%","L");
						$table->addRow();

						while ($rs->getrow()) {
							$id = $rs->field("idSwings");
							$table->addData("<input type=\"checkbox\" name=\"sel[]\" value=\"$id\">");
							$table->addData(addLink($rs->field("de"),"swing_edicao.php?id=$id&pagina=$pg","Editar"));
							$table->addData(addLink($rs->field("email"),"swing_edicao.php?id=$id&pagina=$pg","Editar"));
							$flagAtivo = ($rs->field("flagAtivo")=="S")?"SIM":"NAO";
							$table->addData(addLink($flagAtivo,"swing_edicao.php?id=$id&pagina=$pg","Editar"));								
							$table->addRow();	
						}
