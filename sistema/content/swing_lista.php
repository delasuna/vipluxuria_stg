            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <form method="post" class="d-flex align-items-center" action="swing_lista.php">
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows() > 0) {
                                        while ($rs->getrow()) {
                                            ...
                                            echo "<td><a href='swing_edicao.php?id=$id&pagina=$pg' class='text-decoration-none'>{$rs->field('de')}</a></td>";
                                            echo "<td><a href='swing_edicao.php?id=$id&pagina=$pg' class='text-decoration-none'>{$rs->field('email')}</a></td>";
                                            echo "<td><a href='swing_edicao.php?id=$id&pagina=$pg' class='text-decoration-none'>$flagAtivo</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
