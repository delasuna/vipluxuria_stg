...
if (strlen($lista_exclusao) == 0) { // se não existe registros selecionados
    ...
    $sql = "DELETE FROM bannercentral3 WHERE idBannerCentral3 IN (" . $lista_exclusao . ")";
    $conn->execute($sql);

    echo "<script>location.href='/sistema/content/bannercentral_lista_2.php?clear=1';</script>";
}
