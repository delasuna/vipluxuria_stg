    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Vip Luxúria - Banner Central Mobile 2</h1>
            </div>
            <hr>
                ...
                <div class="card-body">
                    ...
                    <?php
                        ...
                        if ($iSort > 0) {
                            ...
                            switch ($iSort) {
                                case 2:
                                    $orderBy = " ORDER BY descricao $direction";
                                    break;
                                case 3:
                                    $orderBy = " ORDER BY site $direction";
                                    break;
                            }
                        ...
                        if ($busca != "") {
                            ...
                            $whereBusca = " WHERE descricao LIKE '%$buscaSql%'";
                        }

                        $sql = "SELECT * 
                        FROM bannercentralmobile2
                        $whereBusca
                        $orderBy";
                    ...
                    <div>
                        <a class="btn btn-primary" href="bannercentralmobile_edicao_2.php">Novo</a>
                        <a class="btn btn-danger" href="javascript:excluir()">Excluir</a>
                    </div>

                    <!-- Seleção de registros por página -->
                    <form name="form2" id="form2" method="post" action="bannercentralmobile2_lista.php" class="row g-2 mb-3 justify-content-end">
                        <div class="col-auto">
                    ...
                    <div class="d-flex justify-content-around">
                        <form method="get" class="row g-2 mb-3 w-100">
                            ...
                            <div class="col-auto">
                                ...
                                <?php if ($busca != "") { ?>
                                    <a href="bannercentralmobile2_lista.php" class="btn btn-secondary">
                                        Limpar
                                    </a>
                                <?php } ?>
                            </div>
                            ...
                            <table class="table table-striped table-hover align-middle">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <?php $isDescSite = ($iSort === 3 && $iSorted === 3); ?>
                                        <th>
                                            <a href="?Sorting=3<?php echo $isDescSite ? '' : '&Sorted=3'; ?>"
                                            class="text-white text-decoration-none">
                                                Site
                                            </a>
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows()>0) {
                                        while ($rs->getrow()) {
                                            $id = $rs->field("idBannerCentralMobile2");
                                            echo "<tr>";
                                            echo "<td><input type='checkbox' name='sel[]' value='$id'></td>";
                                            echo "<td><a href='bannercentralmobile_edicao_2.php?id=$id&pagina=$pg' class='fw-semibold text-decoration-none'>{$rs->field('descricao')}</a></td>";
                                            echo "<td><a href='bannercentralmobile_edicao_2.php?id=$id&pagina=$pg' class='text-decoration-none'>{$rs->field('site')}</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
...
function excluir() {
    if (confirm('Excluir registros selecionados?')) {
        document.frm.action = "bannercentralmobile2_excluir.php";
        document.frm.submit();
    }
}
</script>
