    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Vip Luxúria - Cidade</h1>
            </div>
            <hr>
                ...
                <div class="card-body">
                    ...
                    <?php
                        ...
                        if ($iSort > 0) {
                            ...
                            switch ($iSort) {
                                case 2:
                                    $orderBy = " ORDER BY cidade $direction";
                                    break;
                                case 3:
                                    $orderBy = " ORDER BY ordem $direction";
                                    break;
                            }
                        ...
                        if ($busca != "") {
                            ...
                            $whereBusca = " WHERE cidade LIKE '%$buscaSql%'";
                        }
                    ...
                    <div>
                        <a class="btn btn-primary" href="cidade_edicao.php">Novo</a>
                        <a class="btn btn-danger" href="javascript:excluir()">Excluir</a>
                    </div>

                    <!-- Seleção de registros por página -->
                    <form name="form2" id="form2" method="post" action="cidade_lista.php" class="row g-2 mb-3 justify-content-end">
                        <div class="col-auto">
                    ...
                    <div class="d-flex justify-content-around">
                        <form method="get" class="row g-2 mb-3 w-100">
                            ...
                            <div class="col-auto">
                                ...
                                <?php if ($busca != "") { ?>
                                    <a href="cidade_lista.php" class="btn btn-secondary">
                                        Limpar
                                    </a>
                                <?php } ?>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows()>0) {
                                        while ($rs->getrow()) {
                                            ...
                                            echo "<td><a href='cidade_edicao.php?id=$id&pagina=$pg' class='fw-semibold text-decoration-none'>{$rs->field('cidade')}</a></td>";
                                            echo "<td><a href='cidade_edicao.php?id=$id&pagina=$pg' class='text-decoration-none'>{$rs->field('ordem')}</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
