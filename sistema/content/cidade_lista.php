			    ...
			    <div id="coluna-esquerda-full">
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='cidade_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							while ($rs->getrow()) {
								$id = $rs->field("idCidade"); // captura a chave primária do recordset
								...
								$table->addData(addLink($rs->field("cidade"),"cidade_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));
								$table->addData(addLink($rs->field("ordem"),"cidade_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));								
								/*
