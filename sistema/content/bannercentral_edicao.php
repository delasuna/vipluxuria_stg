            		...
            		<p> 
						...
						if (strlen($id)>0) { // edição
							$sql = "SELECT * FROM bannercentral2 " 
								 . "WHERE idBannerCentral2=" . $id;
							$rs = new query($conn, $sql);
							if ($rs->getrow()) {
								$idBannerCentral2 = $rs->field("idBannerCentral2");	
						...
						/* 	Formulário */
						$form = new Form("frm", "bannercentral_salvar.php", "POST", "", "100%");
						...
						$form->addHidden("id",$idBannerCentral2); // chave primária
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='bannercentral_lista.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td>
								</tr>
							</table>
						</div>
