			    ...
			    <div id="coluna-esquerda-full">
					...
					<script language="JavaScript">
						function excluir() {
							if (confirm('Excluir registros selecionados?')) {
								...
								//parent.content.document.frm.action = "bannerlateral_excluir.php";
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='bannerlateral_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							while ($rs->getrow()) {
								$id = $rs->field("idBannerLateral"); // captura a chave primária do recordset
								...
								$table->addData(addLink($rs->field("descricao"),"bannerlateral_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));
								$table->addData(addLink($rs->field("site"),"bannerlateral_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));								
								/*
