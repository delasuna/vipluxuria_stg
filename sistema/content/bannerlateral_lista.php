...
<div id="tudo">
    <div id="conteudo">
        ...
        <div id="titulo">
        	<div id="titulo-content"><h1>Banner Lateral</h1></div>
            <div class="traco"></div>
        </div>
            ...
            <div id="principal-content">
			    <div id="coluna-esquerda-full">
					...
					<?php
						...
						$sql = "SELECT * FROM bannerlateral " . getSession("sOrder");
					...
					<form name="form2" method="post" action="bannerlateral_lista.php">
						<div align="right">
							<table>
								<tr>
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									<a class='botao' href='bannerlateral_edicao.php'>&nbsp;Novo&nbsp;</a>
					...
					<?php
						if ($rs->numrows()>0) {
							...
							while ($rs->getrow()) {
								...
								$table->addData(addLink($rs->field("descricao"),"bannerlateral_edicao.php?id=$id&pagina=$pg","Editar registro"));
								$table->addData(addLink($rs->field("site"),"bannerlateral_edicao.php?id=$id&pagina=$pg","Editar registro"));
								$table->addRow();	
							}
