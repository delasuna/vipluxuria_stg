    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Vip Luxúria - Banner Lateral</h1>
            </div>
            <hr>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div>
                        <a class="btn btn-primary" href="bannerlateral_edicao.php">Novo</a>
                        <a class="btn btn-danger" href="javascript:excluir()">Excluir</a>
                    </div>

                    <!-- Seleção de registros por página -->
                    <form name="form2" id="form2" method="post" action="bannerlateral_lista.php" class="row g-2 mb-3 justify-content-end">
                        <div class="col-auto">
                    ...
                    <div class="d-flex justify-content-around">
                        <form method="get" class="row g-2 mb-3 w-100">
                            ...
                            <div class="col-auto">
                                ...
                                <?php if ($busca != "") { ?>
                                    <a href="bannerlateral_lista.php" class="btn btn-secondary">
                                        Limpar
                                    </a>
                                <?php } ?>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows()>0) {
                                        while ($rs->getrow()) {
                                            $id = $rs->field("idBannerLateral");
                                            echo "<tr>";
                                            echo "<td><input type='checkbox' name='sel[]' value='$id'></td>";
                                            echo "<td><a href='bannerlateral_edicao.php?id=$id&pagina=$pg' class='fw-semibold text-decoration-none'>{$rs->field('descricao')}</a></td>";
                                            echo "<td><a href='bannerlateral_edicao.php?id=$id&pagina=$pg' class='text-decoration-none'>{$rs->field('site')}</a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
...
function excluir() {
    if (confirm('Excluir registros selecionados?')) {
        document.frm.action = "bannerlateral_excluir.php";
        document.frm.submit();
    }
}
</script>
