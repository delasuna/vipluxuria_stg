			    ...
			    <div id="coluna-esquerda-full">
            		<p> 
						...
						if (strlen($id)>0) { // edição
							$sql = "SELECT * FROM bannercentralmobile2" 
								 . " WHERE idBannerCentralMobile2=" . $id;
							$rs = new query($conn, $sql);
							if ($rs->getrow()) {
								$idBannerCentralMobile2 = $rs->field("idBannerCentralMobile2");	
						...
						/* 	Formulário */
						$form = new Form("frm", "bannercentralmobile_salvar_2.php", "POST", "", "100%");
						...
						$form->addHidden("id",$idBannerCentralMobile2); // chave primária
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='bannercentralmobile_lista_2.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td>
								</tr>
							</table>
						</div>
