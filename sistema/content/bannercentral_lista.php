			    ...
			    <div id="coluna-esquerda-full">
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='bannercentral_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							while ($rs->getrow()) {
								$id = $rs->field("idBannerCentral2"); // captura a chave primária do recordset
								...
								$table->addData(addLink($rs->field("descricao"),"bannercentral_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));
								$table->addData(addLink($rs->field("site"),"bannercentral_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));								
								/*
