			    ...
			    <div id="coluna-esquerda-full">
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									<a class='botao' href='bannercentral_edicao_2.php'>&nbsp;Novo&nbsp;</a>
					...
					<?php
						if ($rs->numrows()>0) {
							...
							while ($rs->getrow()) {
								...
								$table->addData(addLink($rs->field("descricao"),"bannercentral_edicao_2.php?id=$id&pagina=$pg","Editar registro"));
								$table->addData(addLink($rs->field("site"),"bannercentral_edicao_2.php?id=$id&pagina=$pg","Editar registro"));
								$table->addRow();	
							}
