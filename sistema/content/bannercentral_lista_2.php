...
<head>
    ...
    <title>Vip Luxúria - Banner Central 2</title>
        ...
        <div class="container-fluid mt-4">
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    $sql = "SELECT * FROM bannercentral3 " . getSession("sOrder");
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        ...
                        <form method="post" class="d-flex align-items-center" action="bannercentral_lista_2.php">
