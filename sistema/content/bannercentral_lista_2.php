        ...
        <div id="principal">
            ...
            <div id="principal-content">
			    <div id="coluna-esquerda-full">
					...
					?>
					<form name="form2" method="post" action="bannercentral_lista_2.php">
						<div align="right">
						<table height="5px">
							<tr>
								<td class="LabelFONT">
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='bannercentral_edicao_2.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							while ($rs->getrow()) {
								$id = $rs->field("idBannerCentral3"); // captura a chave primária do recordset
								...
								$table->addData(addLink($rs->field("descricao"),"bannercentral_edicao_2.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));
								$table->addData(addLink($rs->field("site"),"bannercentral_edicao_2.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));								
								/*
