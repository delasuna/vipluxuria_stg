			    ...
			    <div id="coluna-esquerda-full">
            		<p> 
						...
						if (strlen($id)>0) { // edição
							$sql = "SELECT * FROM bannercentralmobile" 
								 . " WHERE idBannerCentralMobile=" . $id;
							$rs = new query($conn, $sql);
							if ($rs->getrow()) {
								$idBannerCentralMobile = $rs->field("idBannerCentralMobile");	
						...
						/* 	Formulário */
						$form = new Form("frm", "bannercentralmobile_salvar.php", "POST", "", "100%");
						...
						$form->addHidden("id",$idBannerCentralMobile); // chave primária
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='bannercentralmobile_lista.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td>
								</tr>
							</table>
						</div>
