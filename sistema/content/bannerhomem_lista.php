...
<div id="tudo">
    <div id="conteudo">
        ...
        <div id="titulo">
        	<div id="titulo-content"><h1>Banner Homem</h1></div>
            <div class="traco"></div>
        </div>
            ...
            <div id="principal-content">
			    <div id="coluna-esquerda-full">
					...
					<?php
						...
						$sql = "SELECT * FROM bannerHomem " . getSession("sOrder");
					...
					<form name="form2" method="post" action="bannerhomem_lista.php">
						<div align="right">
							<table>
								<tr>
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									<a class='botao' href='bannerhomem_edicao.php'>&nbsp;Novo&nbsp;</a>
					...
					<?php
						if ($rs->numrows()>0) {
							...
							while ($rs->getrow()) {
								...
								$table->addData(addLink($rs->field("descricao"),"bannerhomem_edicao.php?id=$id&pagina=$pg","Editar registro"));
								$table->addData(addLink($rs->field("site"),"bannerhomem_edicao.php?id=$id&pagina=$pg","Editar registro"));
								$table->addRow();	
							}
