            		...
            		<p> 
						...
						if (strlen($id)>0) { // edição
							$sql = "SELECT * FROM bannerTransex " 
								 . "WHERE idBannerTransex=" . $id;
							$rs = new query($conn, $sql);
							if ($rs->getrow()) {
								$idBannerTransex = $rs->field("idBannerTransex");	
						...
						/* 	Formulário */
						$form = new Form("frm", "bannertransex_salvar.php", "POST", "", "100%");
						...
						$form->addHidden("id",$idBannerTransex); // chave primária
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='bannertransex_lista.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td>
								</tr>
							</table>
						</div>
