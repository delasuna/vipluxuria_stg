			    ...
			    <div id="coluna-esquerda-full">
            		<p> 
						...
						if (strlen($id)>0) { // edição
							$sql = "SELECT * FROM bannerHomem " 
								 . "WHERE idBannerHomem=" . $id;
							$rs = new query($conn, $sql);
							if ($rs->getrow()) {
								$idBannerHomem = $rs->field("idBannerHomem");	
						...
						/* 	Formulário */
						$form = new Form("frm", "bannerhomem_salvar.php", "POST", "", "100%");
						...
						$form->addHidden("id",$idBannerHomem); // chave primária
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='bannerhomem_lista.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td>
								</tr>
							</table>
						</div>
