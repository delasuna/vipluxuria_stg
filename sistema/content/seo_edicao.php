            ...
            <div id="principal-content">
			    <div id="coluna-esquerda-full">
            		<p> 
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='seo_lista.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td> 
								</tr>
							</table>
						</div>
						...
						/* 	Formulário */
						$form = new Form("frm", "seo_salvar.php", "POST", "", "100%");
						...
						$form->addHidden("id",$idSeo); // chave primária
						$form->addHidden("pagina",getParam("pagina")); // número da página que chamou
						
						$form->addBreak("Dados Gerais");

						$sqlTitulo = "SELECT idTipoSeo, descricao FROM tipoSeo ORDER BY descricao";
						$form->addField("Tipo SEO: *", listboxField($sqlTitulo, "idTipoSeo",$idTipoSeo,"Selecione o Tipo SEO", "", ""));
						$form->addField("title:", textField("title",$title,64,400));						
						$form->addField("description:", textAreaField("description",$description,4,150,1000));						
						$form->addField("keywords:", textAreaField("keywords",$keywords,4,150,1000));  
