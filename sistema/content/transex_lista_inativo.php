    ...
    <div id="conteudo">
      ...
      <div id="titulo">
       		<div id="titulo-content">
				<h1>Anunciantes Transex - Inativos</h1>
            </div>
            <div class="traco"></div>
      </div>
        ...
        <div id="principal">
            ...
            <div id="principal-content">
			    <div id="coluna-esquerda-full">
					...
					<script language="JavaScript">
						function excluir() {
							if (confirm('Excluir registros selecionados?')) {
								...
								//parent.content.document.frm.action = "transex_excluir.php";
					...
					?>
					<form name="form2" method="post" action="transex_lista_inativo.php">
						<div align="right">
						<table height="5px">
							<tr>
								<td class="LabelFONT">
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='transex_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							$table->addColumnHeader("Nome",true,"25%", "L"); // Título, Ordenar?, Largura, Alinhamento
							...
							while ($rs->getrow()) {
								$id = $rs->field("idTransex"); // captura a chave primária do recordset
