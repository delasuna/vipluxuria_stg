            ...
            <div id="principal-content">
			    <div id="coluna-esquerda-full">
            		<p> 
						...
						/* 	Formulário */
						$form = new Form("frm", "cidade_salvar.php", "POST", "", "100%");
						...
						$form->addField("Cidade:", textField("cidade",$cidade,64,250));						
						$form->addField("Ordem:", textField("ordem",$ordem,64,250));

						$form->addBreak("Dados SEO");
						$form->addField("title:", textField("title",$title,64,400));						
						$form->addField("description:", textAreaField("description",$description,3,150,1000));						
						$form->addField("keywords:", textAreaField("keywords",$keywords,3,150,1000));
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='cidade_lista.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td>
								</tr>
							</table>
						</div>
