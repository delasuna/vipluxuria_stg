			    ...
			    <div id="coluna-esquerda-full">
					...
					<div class='acoes2'>
						<table width="100%">
							<tr>
								<td>
									&nbsp; <a class='botao' href='classificados_edicao.php' target=''>&nbsp;Novo&nbsp;</a>
					...
					<?
							...
							$table->addColumnHeader("Título",true,"40%", "L"); // Título, Ordenar?, Largura, Alinhamento
							$table->addColumnHeader("E-mail",true,"60%", "L"); 							
							$table->addRow(); // adiciona linha (TR)
						
							while ($rs->getrow()) {
								$id = $rs->field("idClassificados"); // captura a chave primária do recordset
								...
								$table->addData(addLink($rs->field("titulo"),"classificados_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));
								$table->addData(addLink($rs->field("email"),"classificados_edicao.php?id=$id&pagina=$pg","Clique para consultar ou editar registro"));								
								/*
