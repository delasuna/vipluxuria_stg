...
<head>
    ...
    <title>Vip Luxúria - Classificados</title>
    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Classificados</h1>
            </div>
            <hr>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <div>
                            <a class="btn btn-primary" href="classificados_edicao.php">Novo</a>
                            <a class="btn btn-danger" href="javascript:excluir()">Excluir</a>
                        </div>
                        <form method="post" class="d-flex align-items-center" action="classificados_lista.php">
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows() > 0) {
                                        while ($rs->getrow()) {
                                            ...
                                            $titulo = addLink($rs->field("titulo"), "classificados_edicao.php?id=$id&pagina=$pg", "Clique para editar");
                                            $email = addLink($rs->field("email"), "classificados_edicao.php?id=$id&pagina=$pg", "Clique para editar");
                                            echo "<tr>";
