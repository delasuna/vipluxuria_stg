...
//								$imagemCentral10 = $rs->field("imagemCentral10");																																																								
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='homem_lista.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td>
								</tr>
							</table>
						</div>
						...
						echo "<br>";
							...
							$vars = [
							"idHomem", "nome", "sobrenome", "dote", "imagem1", "imagem2", "imagem3", "imagem4", "imagem5",
						...
						/* 	Formulário */
						$form = new Form("frm", "homem_salvar.php", "POST", "", "100%");
						...
						$form->addHidden("id",$idHomem); // chave primária
...
//						$form->addHidden("imagemCentral10",$imagemCentral10); 
						...
						$form->addFieldColspan2("Aceito Cartão: ", radioField($lista_aceito_cartao, "aceitoCartao",$aceitoCartao));
						$form->add2Field("Tem Vídeo: ", radioField($lista_flag_video, "flagTemVideo",$flagTemVideo), "Nome do vídeo: ", textField("video",$video,33,33));												
						$form->addFieldColspan2("Sexo Virtual: ", radioField($lista_aceito_cartao, "flagSexoVirtual",$flagSexoVirtual));
//						$form->addFieldColspan2("Signo: ", textField("signo",$signo,25,20));
...
//						$form->addFieldColspan2("Mensagem 2: ", textAreaField("mensagem2",$mensagem2,4,150,250));
						...
						if ($imagemComNome != NULL) {
							$form->addFieldColspan2("Imagem Capa: ", "<input type='file' name='imagemComNome' size='25' ><BR>$imagemComNome<BR><img src='$imagemComNome' width='130' height='100' border='1'>");
						} else {
							$form->addFieldColspan2("Imagem Capa: ", "<input type='file' name='imagemComNome' size='25'>");
						}
