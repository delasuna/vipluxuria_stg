...
<div id="tudo">
	<div id="conteudo">
		...
		<div id="titulo">
			<div id="titulo-content"><h1>Newsletters</h1></div>
			<div class="traco"></div>
		</div>
			...
			<div id="principal-content">
				<div id="coluna-esquerda-full">
					...
					<?php
						...
						if ($nr = getParam("numeroRegistros")) {
							setSession("numeroRegistros", $nr);	
						}
					...
					<form name="form2" method="post" action="newsletters_lista.php">
						<div align="right">
							<table>
								<tr>
					...
					<div align="center">
						<form name="frm" method="post">
							...
							if ($rs->numrows() > 0) {
								...
								echo "<td class='DataFONT' align='right' width='47%'>&nbsp;".($rs->numrows()==1?"Foi encontrado ":"Foram encontrados ").$rs->numrows()." registros.</td>";
								echo "</tr>";
								echo "</table>";
							} else {
							...
							$table->addColumnHeader("E-mail", true, "100%", "L");
							$table->addRow();
