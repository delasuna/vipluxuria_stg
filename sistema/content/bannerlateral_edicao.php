            		...
            		<p> 
						...
						if (strlen($id)>0) { // edição
							$sql = "SELECT * FROM bannerlateral " 
								 . "WHERE idBannerLateral=" . $id;
							$rs = new query($conn, $sql);
							if ($rs->getrow()) {
								$idBannerLateral = $rs->field("idBannerLateral");	
						...
						/* 	Formulário */
						$form = new Form("frm", "bannerlateral_salvar.php", "POST", "", "100%");
						...
						$form->addHidden("id",$idBannerLateral); // chave primária
						...
						$form->addField("Nome:", textField("nome",$nome,64,250));						
						$form->addField("Sobrenome:", textField("sobrenome",$sobrenome,64,250));						
							...
							<table width="100%">
								<tr>
									<td>
										...
										<a class='botao' href='bannerlateral_lista.php?<?=$retorno?>' target=''>&nbsp;Cancelar &nbsp;</a>				
									</td>
								</tr>
							</table>
						</div>
