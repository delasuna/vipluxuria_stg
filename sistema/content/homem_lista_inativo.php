    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Anunciantes - Homens</h1>
            </div>
            <hr>
                ...
                <div class="card-body">
                    ...
                    <?php
                        ...
                        if ($iSort > 0) {
                            ...
                            switch ($iSort) {
                                case 2:
                                    $orderBy = " ORDER BY nome $direction";
                                    break;
                                case 3:
                        ...
                        if ($busca != "") {
                            ...
                            $whereBusca = " AND nome LIKE '%$buscaSql%'";
                        }
                        ...
                        $sqlTotal = "SELECT COUNT(*) AS total 
                                    FROM homem 
                                    WHERE flagAtivo = 'Nao' $whereBusca";
                    ...
                    <div>
                        <a class="btn btn-primary" href="homem_edicao.php">Novo</a>
                        <a class="btn btn-danger" href="javascript:excluir()">Excluir</a>
                    </div>

                    <!-- Seleção de registros por página -->
                    <form name="form2" id="form2" method="post" action="homem_lista_inativo.php" class="row g-2 mb-3 justify-content-end">
                        <div class="col-auto">
                    ...
                    <div class="d-flex justify-content-around">
                        <form method="get" class="row g-2 mb-3 w-100">
                            ...
                            <div class="col-auto">
                                ...
                                <?php if ($busca != "") { ?>
                                    <a href="homem_lista_inativo.php" class="btn btn-secondary">
                                        Limpar
                                    </a>
                                <?php } ?>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    if ($rs->numrows()>0) {
                                        while ($rs->getrow()) {
                                            ...
                                            echo "<td><a href='homem_edicao.php?id=$id&pagina=$pg' class='fw-semibold text-decoration-none'>" . htmlspecialchars($rs->field("nome")) . ' ' . htmlspecialchars($rs->field("sobrenome")) . "</a></td>";
