...
<head>
    ...
    <title>Vip Luxúria - Anunciantes Casais & Homens Inativos</title>
    ...
    <div id="conteudo">
        ...
        <div class="container-fluid mt-4">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="text-light">Anunciantes Casais & Homens - Inativos</h1>
            </div>
            <hr>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    <?php
                        ...
                        // Limpar filtros e ordenação se necessário
                        if (getParam("clear") == 1) {
                            setSession("sOrder","");
                            setSession("where","");
                    ...
                    <div class="mb-3 d-flex justify-content-between">
                        ...
                        <form name="form2" method="post" action="homem_lista_inativo.php" class="d-flex align-items-center">
                                    ...
                                    <?php
                                        if ($rs->numrows() > 0) {
                                            while ($rs->getrow()) {
                                                ...
                                                echo "<td><a href='homem_edicao.php?id=$id&pagina=$pg' class='fw-semibold text-decoration-none'>{$rs->field('nome')}</a></td>";
