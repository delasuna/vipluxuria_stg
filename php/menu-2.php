  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="menuNav">
      <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item"><a class="nav-link text-light" href="/como-anunciar/">Anuncie Aqui</a></li>
        <li class="nav-item"><a class="nav-link text-light" href="/vip-blog/">Blog</a></li>
