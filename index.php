...
if (!$resultado) {
    die("Imposs�vel visualizar SEO: " . mysqli_error($conexao));
}
                    ...
                    <section class="acompanhantes-section">
                        <div class="grid-premium">
                            ...
                            function gerarSlug($string)
                            {
                                ...
                                // remove tudo que n�o for letra, n�mero ou espa�o
                                $string = preg_replace('/[^a-z0-9\s-]/', '', $string);

                                // troca espa�os por h�fen
                            ...
                            $resultado = mysqli_query($conexao, $sql);
                            if (!$resultado) {
                                die("Imposs�vel visualizar as anunciantes: " . mysqli_error($conexao));
                            }
                            ...
                            while ($row = mysqli_fetch_assoc($resultado)) {
                                ...
                                $flagVerificada = $row['flagVerificada'] ?? 'N�o';
                            ...
                            ?>
                                ...
                                <?php if (++$contadorCarrossel == 18) { ?>
                                    <!-- Espa�o para banner/carrossel futuro -->
                                <?php } ?>
                            <?php } ?>
                        </div>
