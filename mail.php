...
$corpo = "Seguem as informa��es e imagens a serem alteradas no perfil da anunciante. <BR>"; 
...
if ($anal != "")
	$corpo .= "<BR> Anal: " . $anal;
if ($dominacao != "")
	$corpo .= "<BR> Domina��o: " . $dominacao;
if ($inversao != "")
	$corpo .= "<BR> Invers�o: " . $inversao;
if ($atendoEles != "")
...
if ($acessorios != "")
	$corpo .= "<BR> Acess�rios: " . $acessorios;
if ($eventos != "")
...
$email->FromName  = $nome;
$email->Subject   = 'Atualiza��o de Perfil de Anunciante - Vip Lux�ria';
$email->Body      = $corpo;
